...
- [DbContext Lifetime, Configuration, and Initialization](https://docs.microsoft.com/en-us/ef/core/dbcontext-configuration/#avoiding-dbcontext-threading-issues)
- [c# - How to avoid DbContext threading issues](https://stackoverflow.com/questions/58754584/how-to-avoid-dbcontext-threading-issues-caused-by-frequent-httprequests)
