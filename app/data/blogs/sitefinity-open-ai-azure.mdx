...
1. First, upload a phrase dictionary set in excel.
   ...
   ![Phrase Dictionary](/assets/blogs/sitefinity-open-ai-azure/screen-11.png)
...
2. Then submit to train the model and deploy it (to deploy need to set Translator AI pricing tier from S0 to S1 or upper tier).
   ...
   ![Model Training](/assets/blogs/sitefinity-open-ai-azure/screen-12.png)

3. You will have to confirm it is working. In here, we do API testing via Postman to confirm the custom translation works.

   ![API Testing](/assets/blogs/sitefinity-open-ai-azure/screen-13.png)

4. Then, configure in Sitefinity. Add in the `category=<guid>` in the queryString setting.

   ![Sitefinity Configuration](/assets/blogs/sitefinity-open-ai-azure/screen-14.png)

5. Last, try to send a translation, and it works!

   ![Sitefinity Translation](/assets/blogs/sitefinity-open-ai-azure/screen-15.png)
...
- [Medium - Guide to Azure Custom Translator](https://medium.com/@ankitkumarjha0407/a-guide-to-azure-custom-translator-with-real-life-examples-dictionary-set-c51faf33afcb)
