...
- [Sitefinity KB - Best practies when implementing custom mvc widgets](https://knowledgebase.progress.com/articles/Article/Best-practices-when-implementing-custom-MVC-Widgets)
- [Sitefinity - Register content location with your custom widgets](https://www.progress.com/documentation/sitefinity-cms/for-developers-register-content-location-with-your-custom-widgets)
- [Sitefinity - Implement cache dependencies](https://www.progress.com/documentation/sitefinity-cms/implement-cache-dependencies)
- [Sitefinity KB - How to implement icontentlocatableview for custom widgets](https://knowledgebase.progress.com/articles/Article/how-to-implement-icontentlocatableview-for-custom-widgets)
