...
Firstly, we register a Grammarly account at [Grammarly](https://developer.grammarly.com/)

Add allowed domain of the Sitefinity instance.

Copy the client id as we are going to follow this approach: [Grammarly Developer](https://developer.grammarly.com/docs/editor-sdk-intro#usage)
