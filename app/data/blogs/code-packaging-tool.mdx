...
- [App on GoogleDrive](https://drive.google.com/file/d/1cq26fkmkUsXSVqMqIWoiP0TlY3ZbnaJy/view)

## References

- [ElectronJS](https://www.electronjs.org/)
- [CPU Monitor App](https://redstapler.co/simple-cpu-monitor-app-electron-tutorial-2020/)
- [ElectronStore](https://www.npmjs.com/package/electron-store)