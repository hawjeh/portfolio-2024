...
- [GitHub Gist](https://gist.github.com/hawjeh/175610ad762f6d7e05bebc753fd9aced)

## References

- [Microsoft - Reflection](https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/reflection)
- [Sitefinity KB - Changing the type of a custom field](https://knowledgebase.progress.com/articles/Knowledge/changing-the-type-of-a-custom-field)