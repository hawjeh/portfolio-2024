...
In my recent experience with Sitefinity v15.0, I encountered an unexpected issue related to Sitefinity search indexing using the default Lucene. 
...
After dedicating several hours to both code inspection and scouring online resources, I found an enlightening article. 

It prompted me to take a deeper dive into the issue by decompiling the .dll files to identify any missing pieces.

As my investigation progressed, I opted to implement some code injections to ensure the proper translation of GUIDs within the indexing process.
...
After I read several articles including Benramey and Sitefinity KB, I got my solution process drawn:
...
In my case, I decided to store the taxonomy name for my search purpose later
